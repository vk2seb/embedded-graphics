...
pub trait DrawTarget: Dimensions {
    ...
    ///
    fn blit_sprite(&mut self, key: u32, src_x: u32, src_y: u32, width: u32, height: u32, dst_x: i32, dst_y: i32, color: Option<Self::Color>) -> bool {
